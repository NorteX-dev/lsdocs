...
This website contains a set of guides and references to help ease with the installation of the Light Services bot.
...
If you do not own the bot yet, you can obtain a copy (along with its full & unencrypted source code) over at **BuiltByBit** for just $4.39.

<LinkCard
	title="BuiltByBit"
	description="View & purchase the bot on BuiltByBot."
	href="https://builtbybit.com/resources/ticket-bot-paypal-invoices.22995/"
/>
...
The LS bot _partially_ supports this type of hosting, as you might run into problems during automatic payment updates ([IPN updates](/guides/webhooks)) setup, due to not being able to open API ports. Read more [here](/guides/ipn).
